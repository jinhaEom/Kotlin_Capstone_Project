...
import bu.ac.kr.anyfeeling.service.MusicService.DarkMusicService
import bu.ac.kr.anyfeeling.service.MusicService.FunnyMusicService
import bu.ac.kr.anyfeeling.service.MusicService.GloomyMusicService
...
class FunnyActivity: AppCompatActivity(R.layout.fragment_player) {
    ...
    private fun getVideoListFromServer(){
        val retrofit = Retrofit.Builder()
            ...
            .build()
        retrofit.create(FunnyMusicService::class.java)
            .also {
                it.listMusics7()
